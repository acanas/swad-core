// swad_notification_type.h: notifications about events, sent by email

#ifndef _SWAD_NTF_TYP
#define _SWAD_NTF_TYP
/*
...
#define Ntf_MAX_BYTES_NOTIFY_LOCATION	(2048 + (Ntf_MAX_CHARS_NOTIFY_LOCATION + 1) * Cns_MAX_BYTES_PER_CHAR - 1)	// 4095
