   ...
   if (Gbl.CurrentIns.Ins.InsCod > 0)
	   ...
	   Order++)
	{
	 ...
	 fprintf (Gbl.F.Out,"</a>"
      ...
      fprintf (Gbl.F.Out,"<td align=\"center\" class=\"TIT_TBL\">&nbsp;%s&nbsp;</td>"
