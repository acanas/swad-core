...
const struct Act_Actions ActLst_Actions[ActLst_NUM_ACTIONS] =
  {
   ...
   [ActChgMyIns		] = {1167, 5,TabPrf,Rec_UpdateMyInstitution	,Rec_ShowMySharedRecordAndMore	,{{    0,    0},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3F8}},Act_NORM,Act_1ST},
   [ActChgMyCtr		] = {1168, 5,TabPrf,Rec_UpdateMyCenter		,Rec_ShowMySharedRecordAndMore	,{{    0,    0},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3F8}},Act_NORM,Act_1ST},
   [ActChgMyDpt		] = {1169, 5,TabPrf,Rec_UpdateMyDepartment	,Rec_ShowMySharedRecordAndMore	,{{    0,    0},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3F8}},Act_NORM,Act_1ST},
   [ActChgMyOff		] = {1170, 5,TabPrf,Rec_UpdateMyOffice		,Rec_ShowMySharedRecordAndMore	,{{    0,    0},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3F8}},Act_NORM,Act_1ST},
   [ActChgMyOffPho	] = {1171, 5,TabPrf,Rec_UpdateMyOfficePhone	,Rec_ShowMySharedRecordAndMore	,{{    0,    0},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3F8}},Act_NORM,Act_1ST},
   [ActChgMyNet		] = {1173, 5,TabPrf,Net_UpdateMyWebs		,Rec_ShowMySharedRecordAndMore	,{{    0,    0},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3C6},{0x3C6,0x3F8}},Act_NORM,Act_1ST},
