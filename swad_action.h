...
#define ActEdiTchGui		(ActChgCrsSta +  40)
#define ActSeeSylLec		(ActChgCrsSta +  41)
#define ActSeeSylPra		(ActChgCrsSta +  42)
#define ActEdiSylLec		(ActChgCrsSta +  43)
#define ActEdiSylPra		(ActChgCrsSta +  44)
#define ActDelItmSylLec		(ActChgCrsSta +  45)
#define ActDelItmSylPra		(ActChgCrsSta +  46)
#define ActUp_IteSylLec		(ActChgCrsSta +  47)
#define ActUp_IteSylPra		(ActChgCrsSta +  48)
#define ActDwnIteSylLec		(ActChgCrsSta +  49)
#define ActDwnIteSylPra		(ActChgCrsSta +  50)
#define ActRgtIteSylLec		(ActChgCrsSta +  51)
#define ActRgtIteSylPra		(ActChgCrsSta +  52)
#define ActLftIteSylLec		(ActChgCrsSta +  53)
#define ActLftIteSylPra		(ActChgCrsSta +  54)
#define ActInsIteSylLec		(ActChgCrsSta +  55)
#define ActInsIteSylPra		(ActChgCrsSta +  56)
#define ActModIteSylLec		(ActChgCrsSta +  57)
#define ActModIteSylPra		(ActChgCrsSta +  58)

#define ActEdiBib		(ActChgCrsSta +  59)
#define ActEdiFAQ		(ActChgCrsSta +  60)
#define ActEdiCrsLnk		(ActChgCrsSta +  61)

#define ActChgFrcReaCrsInf	(ActChgCrsSta +  62)
#define ActChgFrcReaTchGui	(ActChgCrsSta +  63)
#define ActChgFrcReaSylLec	(ActChgCrsSta +  64)
#define ActChgFrcReaSylPra	(ActChgCrsSta +  65)
#define ActChgFrcReaBib		(ActChgCrsSta +  66)
#define ActChgFrcReaFAQ		(ActChgCrsSta +  67)
#define ActChgFrcReaCrsLnk	(ActChgCrsSta +  68)

#define ActChgHavReaCrsInf	(ActChgCrsSta +  69)
#define ActChgHavReaTchGui	(ActChgCrsSta +  70)
#define ActChgHavReaSylLec	(ActChgCrsSta +  71)
#define ActChgHavReaSylPra	(ActChgCrsSta +  72)
#define ActChgHavReaBib		(ActChgCrsSta +  73)
#define ActChgHavReaFAQ		(ActChgCrsSta +  74)
#define ActChgHavReaCrsLnk	(ActChgCrsSta +  75)

#define ActSelInfSrcCrsInf	(ActChgCrsSta +  76)
#define ActSelInfSrcTchGui	(ActChgCrsSta +  77)
#define ActSelInfSrcSylLec	(ActChgCrsSta +  78)
#define ActSelInfSrcSylPra	(ActChgCrsSta +  79)
#define ActSelInfSrcBib		(ActChgCrsSta +  80)
#define ActSelInfSrcFAQ		(ActChgCrsSta +  81)
#define ActSelInfSrcCrsLnk	(ActChgCrsSta +  82)
#define ActRcvURLCrsInf		(ActChgCrsSta +  83)
#define ActRcvURLTchGui		(ActChgCrsSta +  84)
#define ActRcvURLSylLec		(ActChgCrsSta +  85)
#define ActRcvURLSylPra		(ActChgCrsSta +  86)
#define ActRcvURLBib		(ActChgCrsSta +  87)
#define ActRcvURLFAQ		(ActChgCrsSta +  88)
#define ActRcvURLCrsLnk		(ActChgCrsSta +  89)
#define ActRcvPagCrsInf		(ActChgCrsSta +  90)
#define ActRcvPagTchGui		(ActChgCrsSta +  91)
#define ActRcvPagSylLec		(ActChgCrsSta +  92)
#define ActRcvPagSylPra		(ActChgCrsSta +  93)
#define ActRcvPagBib		(ActChgCrsSta +  94)
#define ActRcvPagFAQ		(ActChgCrsSta +  95)
#define ActRcvPagCrsLnk		(ActChgCrsSta +  96)
#define ActEditorCrsInf		(ActChgCrsSta +  97)
#define ActEditorTchGui		(ActChgCrsSta +  98)
#define ActEditorSylLec		(ActChgCrsSta +  99)
#define ActEditorSylPra		(ActChgCrsSta + 100)
#define ActEditorBib		(ActChgCrsSta + 101)
#define ActEditorFAQ		(ActChgCrsSta + 102)
#define ActEditorCrsLnk		(ActChgCrsSta + 103)
#define ActPlaTxtEdiCrsInf	(ActChgCrsSta + 104)
#define ActPlaTxtEdiTchGui	(ActChgCrsSta + 105)
#define ActPlaTxtEdiSylLec	(ActChgCrsSta + 106)
#define ActPlaTxtEdiSylPra	(ActChgCrsSta + 107)
#define ActPlaTxtEdiBib		(ActChgCrsSta + 108)
#define ActPlaTxtEdiFAQ		(ActChgCrsSta + 109)
#define ActPlaTxtEdiCrsLnk	(ActChgCrsSta + 110)
#define ActRchTxtEdiCrsInf	(ActChgCrsSta + 111)
#define ActRchTxtEdiTchGui	(ActChgCrsSta + 112)
#define ActRchTxtEdiSylLec	(ActChgCrsSta + 113)
#define ActRchTxtEdiSylPra	(ActChgCrsSta + 114)
#define ActRchTxtEdiBib		(ActChgCrsSta + 115)
#define ActRchTxtEdiFAQ		(ActChgCrsSta + 116)
#define ActRchTxtEdiCrsLnk	(ActChgCrsSta + 117)
#define ActRcvPlaTxtCrsInf	(ActChgCrsSta + 118)
#define ActRcvPlaTxtTchGui	(ActChgCrsSta + 119)
#define ActRcvPlaTxtSylLec	(ActChgCrsSta + 120)
#define ActRcvPlaTxtSylPra	(ActChgCrsSta + 121)
#define ActRcvPlaTxtBib		(ActChgCrsSta + 122)
#define ActRcvPlaTxtFAQ		(ActChgCrsSta + 123)
#define ActRcvPlaTxtCrsLnk	(ActChgCrsSta + 124)
#define ActRcvRchTxtCrsInf	(ActChgCrsSta + 125)
#define ActRcvRchTxtTchGui	(ActChgCrsSta + 126)
#define ActRcvRchTxtSylLec	(ActChgCrsSta + 127)
#define ActRcvRchTxtSylPra	(ActChgCrsSta + 128)
#define ActRcvRchTxtBib		(ActChgCrsSta + 129)
#define ActRcvRchTxtFAQ		(ActChgCrsSta + 130)
#define ActRcvRchTxtCrsLnk	(ActChgCrsSta + 131)

#define ActPrnCrsTT		(ActChgCrsSta + 132)
#define ActEdiCrsTT		(ActChgCrsSta + 133)
#define ActChgCrsTT		(ActChgCrsSta + 134)
#define ActChgCrsTT1stDay	(ActChgCrsSta + 135)
