...
#define ActPrnOneAsg		(ActChgCalCrs1stDay + 19)
#define ActNewAsg		(ActChgCalCrs1stDay + 20)
#define ActChgAsg		(ActChgCalCrs1stDay + 21)
#define ActReqRemAsg		(ActChgCalCrs1stDay + 22)
#define ActRemAsg		(ActChgCalCrs1stDay + 23)
#define ActHidAsg		(ActChgCalCrs1stDay + 24)
#define ActShoAsg		(ActChgCalCrs1stDay + 25)

#define ActSeeTst		(ActChgCalCrs1stDay + 26)
#define ActAssTst		(ActChgCalCrs1stDay + 27)
#define ActEdiTstQst		(ActChgCalCrs1stDay + 28)
#define ActEdiOneTstQst		(ActChgCalCrs1stDay + 29)
#define ActReqImpTstQst		(ActChgCalCrs1stDay + 30)
#define ActImpTstQst		(ActChgCalCrs1stDay + 31)
#define ActLstTstQst		(ActChgCalCrs1stDay + 32)
#define ActRcvTstQst		(ActChgCalCrs1stDay + 33)
#define ActReqRemTstQst		(ActChgCalCrs1stDay + 34)
#define ActRemTstQst		(ActChgCalCrs1stDay + 35)
#define ActShfTstQst		(ActChgCalCrs1stDay + 36)
#define ActCfgTst		(ActChgCalCrs1stDay + 37)
#define ActEnableTag		(ActChgCalCrs1stDay + 38)
#define ActDisableTag		(ActChgCalCrs1stDay + 39)
#define ActRenTag		(ActChgCalCrs1stDay + 40)
#define ActRcvCfgTst		(ActChgCalCrs1stDay + 41)

#define ActReqSeeMyTstRes	(ActChgCalCrs1stDay + 42)
#define ActSeeMyTstRes		(ActChgCalCrs1stDay + 43)
#define ActSeeOneTstResMe	(ActChgCalCrs1stDay + 44)
#define ActReqSeeUsrTstRes	(ActChgCalCrs1stDay + 45)
#define ActSeeUsrTstRes		(ActChgCalCrs1stDay + 46)
#define ActSeeOneTstResOth	(ActChgCalCrs1stDay + 47)

#define ActSeeOneSvy		(ActChgCalCrs1stDay + 48)
#define ActAnsSvy		(ActChgCalCrs1stDay + 49)
#define ActFrmNewSvy		(ActChgCalCrs1stDay + 50)
#define ActEdiOneSvy		(ActChgCalCrs1stDay + 51)
#define ActNewSvy		(ActChgCalCrs1stDay + 52)
#define ActChgSvy		(ActChgCalCrs1stDay + 53)
#define ActReqRemSvy		(ActChgCalCrs1stDay + 54)
#define ActRemSvy		(ActChgCalCrs1stDay + 55)
#define ActReqRstSvy		(ActChgCalCrs1stDay + 56)
#define ActRstSvy		(ActChgCalCrs1stDay + 57)
#define ActHidSvy		(ActChgCalCrs1stDay + 58)
#define ActShoSvy		(ActChgCalCrs1stDay + 59)
#define ActEdiOneSvyQst		(ActChgCalCrs1stDay + 60)
#define ActRcvSvyQst		(ActChgCalCrs1stDay + 61)
#define ActReqRemSvyQst		(ActChgCalCrs1stDay + 62)
#define ActRemSvyQst		(ActChgCalCrs1stDay + 63)

#define ActSeeOneExaAnn		(ActChgCalCrs1stDay + 64)
#define ActSeeDatExaAnn		(ActChgCalCrs1stDay + 65)
#define ActEdiExaAnn		(ActChgCalCrs1stDay + 66)
#define ActRcvExaAnn		(ActChgCalCrs1stDay + 67)
#define ActPrnExaAnn		(ActChgCalCrs1stDay + 68)
#define ActReqRemExaAnn		(ActChgCalCrs1stDay + 69)
#define ActRemExaAnn		(ActChgCalCrs1stDay + 70)
#define ActHidExaAnn		(ActChgCalCrs1stDay + 71)
#define ActShoExaAnn		(ActChgCalCrs1stDay + 72)
