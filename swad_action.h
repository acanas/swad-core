...
#define ActAdmBrf		(ActSeeAllStaCrs+10)
#define ActMFUAct		(ActSeeAllStaCrs+11)
// Secondary actions
#define ActAutUsrInt		(ActSeeAllStaCrs+12)
#define ActAutUsrExt		(ActSeeAllStaCrs+13)
#define ActAutUsrChgLan		(ActSeeAllStaCrs+14)
#define ActLogOut		(ActSeeAllStaCrs+15)
#define ActAnnSee		(ActSeeAllStaCrs+16)
#define ActChgMyRol		(ActSeeAllStaCrs+17)
#define ActCreUsrAcc		(ActSeeAllStaCrs+18)
#define ActRemIDMe		(ActSeeAllStaCrs+19)
#define ActNewIDMe		(ActSeeAllStaCrs+20)
#define ActRemOldNic		(ActSeeAllStaCrs+21)
#define ActChgNic		(ActSeeAllStaCrs+22)
#define ActRemOldMai		(ActSeeAllStaCrs+23)
#define ActChgMai		(ActSeeAllStaCrs+24)
#define ActCnfMai		(ActSeeAllStaCrs+25)
#define ActReqSndNewPwd		(ActSeeAllStaCrs+26)
#define ActSndNewPwd		(ActSeeAllStaCrs+27)
#define ActFrmChgMyPwd		(ActSeeAllStaCrs+28)
