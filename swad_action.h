...
#define ActSeeOneSvy		(ActChgCalCrs1stDay + 49)
#define ActAnsSvy		(ActChgCalCrs1stDay + 50)
#define ActFrmNewSvy		(ActChgCalCrs1stDay + 51)
#define ActEdiOneSvy		(ActChgCalCrs1stDay + 52)
#define ActNewSvy		(ActChgCalCrs1stDay + 53)
#define ActChgSvy		(ActChgCalCrs1stDay + 54)
#define ActReqRemSvy		(ActChgCalCrs1stDay + 55)
#define ActRemSvy		(ActChgCalCrs1stDay + 56)
#define ActReqRstSvy		(ActChgCalCrs1stDay + 57)
#define ActRstSvy		(ActChgCalCrs1stDay + 58)
#define ActHidSvy		(ActChgCalCrs1stDay + 59)
#define ActShoSvy		(ActChgCalCrs1stDay + 60)
#define ActEdiOneSvyQst		(ActChgCalCrs1stDay + 61)
#define ActRcvSvyQst		(ActChgCalCrs1stDay + 62)
