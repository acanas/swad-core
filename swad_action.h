...
#define Act_NUM_ACTIONS	(1 + 9 + 185 + 43 + 17 + 47 + 41 + 24 + 115 + 157 + 437 + 165 + 33 + 15 + 72)
...
#define ActSeeFor		(ActWebSvc +   4)
#define ActSeeChtRms		(ActWebSvc +   5)
...
#define ActRcvSocPstGbl		(ActWebSvc +  10)
...
#define ActReqOthPubPrf		(ActWebSvc +  22)

#define ActRcvSocPstUsr		(ActWebSvc +  23)
#define ActRcvSocComUsr		(ActWebSvc +  24)
#define ActShaSocNotUsr		(ActWebSvc +  25)
#define ActUnsSocNotUsr		(ActWebSvc +  26)
#define ActFavSocNotUsr		(ActWebSvc +  27)
#define ActUnfSocNotUsr		(ActWebSvc +  28)
...
#define ActSeeOthPubPrf		(ActWebSvc +  35)
#define ActCal1stClkTim		(ActWebSvc +  36)
#define ActCalNumClk		(ActWebSvc +  37)
#define ActCalNumFilVie		(ActWebSvc +  38)
#define ActCalNumForPst		(ActWebSvc +  39)
#define ActCalNumMsgSnt		(ActWebSvc +  40)

#define ActFolUsr		(ActWebSvc +  41)
#define ActUnfUsr		(ActWebSvc +  42)
#define ActSeeFlg		(ActWebSvc +  43)
#define ActSeeFlr		(ActWebSvc +  44)

#define ActSeeForCrsUsr		(ActWebSvc +  45)
#define ActSeeForCrsTch		(ActWebSvc +  46)
#define ActSeeForDegUsr		(ActWebSvc +  47)
#define ActSeeForDegTch		(ActWebSvc +  48)
#define ActSeeForCtrUsr		(ActWebSvc +  49)
#define ActSeeForCtrTch		(ActWebSvc +  50)
#define ActSeeForInsUsr		(ActWebSvc +  51)
#define ActSeeForInsTch		(ActWebSvc +  52)
#define ActSeeForGenUsr		(ActWebSvc +  53)
#define ActSeeForGenTch		(ActWebSvc +  54)
#define ActSeeForSWAUsr		(ActWebSvc +  55)
#define ActSeeForSWATch		(ActWebSvc +  56)
#define ActSeePstForCrsUsr	(ActWebSvc +  57)
#define ActSeePstForCrsTch	(ActWebSvc +  58)
#define ActSeePstForDegUsr	(ActWebSvc +  59)
#define ActSeePstForDegTch	(ActWebSvc +  60)
#define ActSeePstForCtrUsr	(ActWebSvc +  61)
#define ActSeePstForCtrTch	(ActWebSvc +  62)
#define ActSeePstForInsUsr	(ActWebSvc +  63)
#define ActSeePstForInsTch	(ActWebSvc +  64)
#define ActSeePstForGenUsr	(ActWebSvc +  65)
#define ActSeePstForGenTch	(ActWebSvc +  66)
#define ActSeePstForSWAUsr	(ActWebSvc +  67)
#define ActSeePstForSWATch	(ActWebSvc +  68)
#define ActRcvThrForCrsUsr	(ActWebSvc +  69)
#define ActRcvThrForCrsTch	(ActWebSvc +  70)
#define ActRcvThrForDegUsr	(ActWebSvc +  71)
#define ActRcvThrForDegTch	(ActWebSvc +  72)
#define ActRcvThrForCtrUsr	(ActWebSvc +  73)
#define ActRcvThrForCtrTch	(ActWebSvc +  74)
#define ActRcvThrForInsUsr	(ActWebSvc +  75)
#define ActRcvThrForInsTch	(ActWebSvc +  76)
#define ActRcvThrForGenUsr	(ActWebSvc +  77)
#define ActRcvThrForGenTch	(ActWebSvc +  78)
#define ActRcvThrForSWAUsr	(ActWebSvc +  79)
#define ActRcvThrForSWATch	(ActWebSvc +  80)
#define ActRcvRepForCrsUsr	(ActWebSvc +  81)
#define ActRcvRepForCrsTch	(ActWebSvc +  82)
#define ActRcvRepForDegUsr	(ActWebSvc +  83)
#define ActRcvRepForDegTch	(ActWebSvc +  84)
#define ActRcvRepForCtrUsr	(ActWebSvc +  85)
#define ActRcvRepForCtrTch	(ActWebSvc +  86)
#define ActRcvRepForInsUsr	(ActWebSvc +  87)
#define ActRcvRepForInsTch	(ActWebSvc +  88)
#define ActRcvRepForGenUsr	(ActWebSvc +  89)
#define ActRcvRepForGenTch	(ActWebSvc +  90)
#define ActRcvRepForSWAUsr	(ActWebSvc +  91)
#define ActRcvRepForSWATch	(ActWebSvc +  92)
#define ActReqDelThrCrsUsr	(ActWebSvc +  93)
#define ActReqDelThrCrsTch	(ActWebSvc +  94)
#define ActReqDelThrDegUsr	(ActWebSvc +  95)
#define ActReqDelThrDegTch	(ActWebSvc +  96)
#define ActReqDelThrCtrUsr	(ActWebSvc +  97)
#define ActReqDelThrCtrTch	(ActWebSvc +  98)
#define ActReqDelThrInsUsr	(ActWebSvc +  99)
#define ActReqDelThrInsTch	(ActWebSvc + 100)
#define ActReqDelThrGenUsr	(ActWebSvc + 101)
#define ActReqDelThrGenTch	(ActWebSvc + 102)
#define ActReqDelThrSWAUsr	(ActWebSvc + 103)
#define ActReqDelThrSWATch	(ActWebSvc + 104)
#define ActDelThrForCrsUsr	(ActWebSvc + 105)
#define ActDelThrForCrsTch	(ActWebSvc + 106)
#define ActDelThrForDegUsr	(ActWebSvc + 107)
#define ActDelThrForDegTch	(ActWebSvc + 108)
#define ActDelThrForCtrUsr	(ActWebSvc + 109)
#define ActDelThrForCtrTch	(ActWebSvc + 110)
#define ActDelThrForInsUsr	(ActWebSvc + 111)
#define ActDelThrForInsTch	(ActWebSvc + 112)
#define ActDelThrForGenUsr	(ActWebSvc + 113)
#define ActDelThrForGenTch	(ActWebSvc + 114)
#define ActDelThrForSWAUsr	(ActWebSvc + 115)
#define ActDelThrForSWATch	(ActWebSvc + 116)
#define ActCutThrForCrsUsr	(ActWebSvc + 117)
#define ActCutThrForCrsTch	(ActWebSvc + 118)
#define ActCutThrForDegUsr	(ActWebSvc + 119)
#define ActCutThrForDegTch	(ActWebSvc + 120)
#define ActCutThrForCtrUsr	(ActWebSvc + 121)
#define ActCutThrForCtrTch	(ActWebSvc + 122)
#define ActCutThrForInsUsr	(ActWebSvc + 123)
#define ActCutThrForInsTch	(ActWebSvc + 124)
#define ActCutThrForGenUsr	(ActWebSvc + 125)
#define ActCutThrForGenTch	(ActWebSvc + 126)
#define ActCutThrForSWAUsr	(ActWebSvc + 127)
#define ActCutThrForSWATch	(ActWebSvc + 128)
#define ActPasThrForCrsUsr	(ActWebSvc + 129)
#define ActPasThrForCrsTch	(ActWebSvc + 130)
#define ActPasThrForDegUsr	(ActWebSvc + 131)
#define ActPasThrForDegTch	(ActWebSvc + 132)
#define ActPasThrForCtrUsr	(ActWebSvc + 133)
#define ActPasThrForCtrTch	(ActWebSvc + 134)
#define ActPasThrForInsUsr	(ActWebSvc + 135)
#define ActPasThrForInsTch	(ActWebSvc + 136)
#define ActPasThrForGenUsr	(ActWebSvc + 137)
#define ActPasThrForGenTch	(ActWebSvc + 138)
#define ActPasThrForSWAUsr	(ActWebSvc + 139)
#define ActPasThrForSWATch	(ActWebSvc + 140)
#define ActDelPstForCrsUsr	(ActWebSvc + 141)
#define ActDelPstForCrsTch	(ActWebSvc + 142)
#define ActDelPstForDegUsr	(ActWebSvc + 143)
#define ActDelPstForDegTch	(ActWebSvc + 144)
#define ActDelPstForCtrUsr	(ActWebSvc + 145)
#define ActDelPstForCtrTch	(ActWebSvc + 146)
#define ActDelPstForInsUsr	(ActWebSvc + 147)
#define ActDelPstForInsTch	(ActWebSvc + 148)
#define ActDelPstForGenUsr	(ActWebSvc + 149)
#define ActDelPstForGenTch	(ActWebSvc + 150)
#define ActDelPstForSWAUsr	(ActWebSvc + 151)
#define ActDelPstForSWATch	(ActWebSvc + 152)
#define ActEnbPstForCrsUsr	(ActWebSvc + 153)
#define ActEnbPstForCrsTch	(ActWebSvc + 154)
#define ActEnbPstForDegUsr	(ActWebSvc + 155)
#define ActEnbPstForDegTch	(ActWebSvc + 156)
#define ActEnbPstForCtrUsr	(ActWebSvc + 157)
#define ActEnbPstForCtrTch	(ActWebSvc + 158)
#define ActEnbPstForInsUsr	(ActWebSvc + 159)
#define ActEnbPstForInsTch	(ActWebSvc + 160)
#define ActEnbPstForGenUsr	(ActWebSvc + 161)
#define ActEnbPstForGenTch	(ActWebSvc + 162)
#define ActEnbPstForSWAUsr	(ActWebSvc + 163)
#define ActEnbPstForSWATch	(ActWebSvc + 164)
#define ActDisPstForCrsUsr	(ActWebSvc + 165)
#define ActDisPstForCrsTch	(ActWebSvc + 166)
#define ActDisPstForDegUsr	(ActWebSvc + 167)
#define ActDisPstForDegTch	(ActWebSvc + 168)
#define ActDisPstForCtrUsr	(ActWebSvc + 169)
#define ActDisPstForCtrTch	(ActWebSvc + 170)
#define ActDisPstForInsUsr	(ActWebSvc + 171)
#define ActDisPstForInsTch	(ActWebSvc + 172)
#define ActDisPstForGenUsr	(ActWebSvc + 173)
#define ActDisPstForGenTch	(ActWebSvc + 174)
#define ActDisPstForSWAUsr	(ActWebSvc + 175)
#define ActDisPstForSWATch	(ActWebSvc + 176)

#define ActCht			(ActWebSvc + 177)

#define ActSeeNewNtf		(ActWebSvc + 178)
#define ActMrkNtfSee		(ActWebSvc + 179)
#define ActSeeMai		(ActWebSvc + 180)
#define ActEdiMai		(ActWebSvc + 181)
#define ActNewMai		(ActWebSvc + 182)
#define ActRemMai		(ActWebSvc + 183)
#define ActRenMaiSho		(ActWebSvc + 184)
#define ActRenMaiFul		(ActWebSvc + 185)
...
#define ActReqMsgUsr		(ActRemDupUsr +   3)
#define ActSeeRcvMsg		(ActRemDupUsr +   4)
#define ActSeeSntMsg		(ActRemDupUsr +   5)
#define ActMaiStd		(ActRemDupUsr +   6)
// Secondary actions
#define ActWriAnn		(ActRemDupUsr +   7)
#define ActRcvAnn		(ActRemDupUsr +   8)
#define ActHidAnn		(ActRemDupUsr +   9)
#define ActRevAnn		(ActRemDupUsr +  10)
#define ActRemAnn		(ActRemDupUsr +  11)
#define ActSeeOneNot		(ActRemDupUsr +  12)
#define ActWriNot		(ActRemDupUsr +  13)
#define ActRcvNot		(ActRemDupUsr +  14)
#define ActHidNot		(ActRemDupUsr +  15)
#define ActRevNot		(ActRemDupUsr +  16)
#define ActReqRemNot		(ActRemDupUsr +  17)
#define ActRemNot		(ActRemDupUsr +  18)

#define ActRcvMsgUsr		(ActRemDupUsr +  19)
#define ActReqDelAllSntMsg	(ActRemDupUsr +  20)
#define ActReqDelAllRcvMsg	(ActRemDupUsr +  21)
#define ActDelAllSntMsg		(ActRemDupUsr +  22)
#define ActDelAllRcvMsg		(ActRemDupUsr +  23)
#define ActDelSntMsg		(ActRemDupUsr +  24)
#define ActDelRcvMsg		(ActRemDupUsr +  25)
#define ActExpSntMsg		(ActRemDupUsr +  26)
#define ActExpRcvMsg		(ActRemDupUsr +  27)
#define ActConSntMsg		(ActRemDupUsr +  28)
#define ActConRcvMsg		(ActRemDupUsr +  29)
#define ActLstBanUsr		(ActRemDupUsr +  30)
#define ActBanUsrMsg		(ActRemDupUsr +  31)
#define ActUnbUsrMsg		(ActRemDupUsr +  32)
#define ActUnbUsrLst		(ActRemDupUsr +  33)
