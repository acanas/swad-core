...
#define ActReqSndNewPwd		(ActSeeAllStaCrs+ 5)
#define ActFrmChgMyPwd		(ActSeeAllStaCrs+ 6)
#define ActReqEdiRecCom		(ActSeeAllStaCrs+ 7)
#define ActReqMyPho		(ActSeeAllStaCrs+ 8)
#define ActReqEdiMyIns		(ActSeeAllStaCrs+ 9)
#define ActReqEdiMyNet		(ActSeeAllStaCrs+10)
#define ActEdiPrf		(ActSeeAllStaCrs+11)
