...
#define Act_NUM_ACTIONS	(1 + 8 + 61 + 38 + 12 + 42 + 36 + 19 + 110 + 159 + 437 + 176 + 169 + 15 + 67)

#define Act_MAX_ACTION_COD 1774
...
#define ActReqAddStdPrj		(ActChgCrsTT1stDay +  40)
#define ActReqAddTutPrj		(ActChgCrsTT1stDay +  41)
#define ActReqAddEvlPrj		(ActChgCrsTT1stDay +  42)
#define ActAddStdPrj		(ActChgCrsTT1stDay +  43)
#define ActAddTutPrj		(ActChgCrsTT1stDay +  44)
#define ActAddEvlPrj		(ActChgCrsTT1stDay +  45)
#define ActReqRemStdPrj		(ActChgCrsTT1stDay +  46)
#define ActReqRemTutPrj		(ActChgCrsTT1stDay +  47)
#define ActReqRemEvlPrj		(ActChgCrsTT1stDay +  48)
#define ActRemStdPrj		(ActChgCrsTT1stDay +  49)
#define ActRemTutPrj		(ActChgCrsTT1stDay +  50)
#define ActRemEvlPrj		(ActChgCrsTT1stDay +  51)

#define ActAdmDocPrj		(ActChgCrsTT1stDay +  52)
#define ActReqRemFilDocPrj	(ActChgCrsTT1stDay +  53)
#define ActRemFilDocPrj		(ActChgCrsTT1stDay +  54)
#define ActRemFolDocPrj		(ActChgCrsTT1stDay +  55)
#define ActCopDocPrj		(ActChgCrsTT1stDay +  56)
#define ActPasDocPrj		(ActChgCrsTT1stDay +  57)
#define ActRemTreDocPrj		(ActChgCrsTT1stDay +  58)
#define ActFrmCreDocPrj		(ActChgCrsTT1stDay +  59)
#define ActCreFolDocPrj		(ActChgCrsTT1stDay +  60)
#define ActCreLnkDocPrj		(ActChgCrsTT1stDay +  61)
#define ActRenFolDocPrj		(ActChgCrsTT1stDay +  62)
#define ActRcvFilDocPrjDZ	(ActChgCrsTT1stDay +  63)
#define ActRcvFilDocPrjCla	(ActChgCrsTT1stDay +  64)
#define ActExpDocPrj		(ActChgCrsTT1stDay +  65)
#define ActConDocPrj		(ActChgCrsTT1stDay +  66)
#define ActZIPDocPrj		(ActChgCrsTT1stDay +  67)
#define ActReqDatDocPrj		(ActChgCrsTT1stDay +  68)
#define ActChgDatDocPrj		(ActChgCrsTT1stDay +  69)
#define ActDowDocPrj		(ActChgCrsTT1stDay +  70)

#define ActAdmAssPrj		(ActChgCrsTT1stDay +  71)
#define ActReqRemFilAssPrj	(ActChgCrsTT1stDay +  72)
#define ActRemFilAssPrj		(ActChgCrsTT1stDay +  73)
#define ActRemFolAssPrj		(ActChgCrsTT1stDay +  74)
#define ActCopAssPrj		(ActChgCrsTT1stDay +  75)
#define ActPasAssPrj		(ActChgCrsTT1stDay +  76)
#define ActRemTreAssPrj		(ActChgCrsTT1stDay +  77)
#define ActFrmCreAssPrj		(ActChgCrsTT1stDay +  78)
#define ActCreFolAssPrj		(ActChgCrsTT1stDay +  79)
#define ActCreLnkAssPrj		(ActChgCrsTT1stDay +  80)
#define ActRenFolAssPrj		(ActChgCrsTT1stDay +  81)
#define ActRcvFilAssPrjDZ	(ActChgCrsTT1stDay +  82)
#define ActRcvFilAssPrjCla	(ActChgCrsTT1stDay +  83)
#define ActExpAssPrj		(ActChgCrsTT1stDay +  84)
#define ActConAssPrj		(ActChgCrsTT1stDay +  85)
#define ActZIPAssPrj		(ActChgCrsTT1stDay +  86)
#define ActReqDatAssPrj		(ActChgCrsTT1stDay +  87)
#define ActChgDatAssPrj		(ActChgCrsTT1stDay +  88)
#define ActDowAssPrj		(ActChgCrsTT1stDay +  89)

#define ActSeeTst		(ActChgCrsTT1stDay +  90)
#define ActAssTst		(ActChgCrsTT1stDay +  91)
#define ActEdiTstQst		(ActChgCrsTT1stDay +  92)
#define ActEdiOneTstQst		(ActChgCrsTT1stDay +  93)
#define ActReqImpTstQst		(ActChgCrsTT1stDay +  94)
#define ActImpTstQst		(ActChgCrsTT1stDay +  95)
#define ActLstTstQst		(ActChgCrsTT1stDay +  96)
#define ActRcvTstQst		(ActChgCrsTT1stDay +  97)
#define ActReqRemTstQst		(ActChgCrsTT1stDay +  98)
#define ActRemTstQst		(ActChgCrsTT1stDay +  99)
#define ActShfTstQst		(ActChgCrsTT1stDay + 100)
#define ActCfgTst		(ActChgCrsTT1stDay + 101)
#define ActEnableTag		(ActChgCrsTT1stDay + 102)
#define ActDisableTag		(ActChgCrsTT1stDay + 103)
#define ActRenTag		(ActChgCrsTT1stDay + 104)
#define ActRcvCfgTst		(ActChgCrsTT1stDay + 105)

#define ActReqSeeMyTstRes	(ActChgCrsTT1stDay + 106)
#define ActSeeMyTstRes		(ActChgCrsTT1stDay + 107)
#define ActSeeOneTstResMe	(ActChgCrsTT1stDay + 108)
#define ActReqSeeUsrTstRes	(ActChgCrsTT1stDay + 109)
#define ActSeeUsrTstRes		(ActChgCrsTT1stDay + 110)
#define ActSeeOneTstResOth	(ActChgCrsTT1stDay + 111)

#define ActSeeOneGam		(ActChgCrsTT1stDay + 112)
#define ActPlyGam		(ActChgCrsTT1stDay + 113)
#define ActPlyGam1stQst		(ActChgCrsTT1stDay + 114)
#define ActPlyGamNxtQst		(ActChgCrsTT1stDay + 115)
#define ActPlyGamAns		(ActChgCrsTT1stDay + 116)
#define ActAnsGam		(ActChgCrsTT1stDay + 117)
#define ActFrmNewGam		(ActChgCrsTT1stDay + 118)
#define ActEdiOneGam		(ActChgCrsTT1stDay + 119)
#define ActNewGam		(ActChgCrsTT1stDay + 120)
#define ActChgGam		(ActChgCrsTT1stDay + 121)
#define ActReqRemGam		(ActChgCrsTT1stDay + 122)
#define ActRemGam		(ActChgCrsTT1stDay + 123)
#define ActReqRstGam		(ActChgCrsTT1stDay + 124)
#define ActRstGam		(ActChgCrsTT1stDay + 125)
#define ActHidGam		(ActChgCrsTT1stDay + 126)
#define ActShoGam		(ActChgCrsTT1stDay + 127)
#define ActAddOneGamQst		(ActChgCrsTT1stDay + 128)
#define ActGamLstTstQst		(ActChgCrsTT1stDay + 129)
#define ActAddTstQstToGam	(ActChgCrsTT1stDay + 130)
#define ActReqRemGamQst		(ActChgCrsTT1stDay + 131)
#define ActRemGamQst		(ActChgCrsTT1stDay + 132)
#define ActUp_GamQst		(ActChgCrsTT1stDay + 133)
#define ActDwnGamQst		(ActChgCrsTT1stDay + 134)

#define ActSeeOneSvy		(ActChgCrsTT1stDay + 135)
#define ActAnsSvy		(ActChgCrsTT1stDay + 136)
#define ActFrmNewSvy		(ActChgCrsTT1stDay + 137)
#define ActEdiOneSvy		(ActChgCrsTT1stDay + 138)
#define ActNewSvy		(ActChgCrsTT1stDay + 139)
#define ActChgSvy		(ActChgCrsTT1stDay + 140)
#define ActReqRemSvy		(ActChgCrsTT1stDay + 141)
#define ActRemSvy		(ActChgCrsTT1stDay + 142)
#define ActReqRstSvy		(ActChgCrsTT1stDay + 143)
#define ActRstSvy		(ActChgCrsTT1stDay + 144)
#define ActHidSvy		(ActChgCrsTT1stDay + 145)
#define ActShoSvy		(ActChgCrsTT1stDay + 146)
#define ActEdiOneSvyQst		(ActChgCrsTT1stDay + 147)
#define ActRcvSvyQst		(ActChgCrsTT1stDay + 148)
#define ActReqRemSvyQst		(ActChgCrsTT1stDay + 149)
#define ActRemSvyQst		(ActChgCrsTT1stDay + 150)

#define ActSeeOneExaAnn		(ActChgCrsTT1stDay + 151)
#define ActSeeDatExaAnn		(ActChgCrsTT1stDay + 152)
#define ActEdiExaAnn		(ActChgCrsTT1stDay + 153)
#define ActRcvExaAnn		(ActChgCrsTT1stDay + 154)
#define ActPrnExaAnn		(ActChgCrsTT1stDay + 155)
#define ActReqRemExaAnn		(ActChgCrsTT1stDay + 156)
#define ActRemExaAnn		(ActChgCrsTT1stDay + 157)
#define ActHidExaAnn		(ActChgCrsTT1stDay + 158)
#define ActShoExaAnn		(ActChgCrsTT1stDay + 159)
