...
#define Act_MAX_ACTION_COD		1928
...
#define ActRenPrgRsc		(ActChgCrsSta +  32)
#define ActReqRemPrgRsc		(ActChgCrsSta +  33)
#define ActRemPrgRsc		(ActChgCrsSta +  34)
#define ActHidPrgRsc		(ActChgCrsSta +  35)
#define ActUnhPrgRsc		(ActChgCrsSta +  36)
#define ActUp_PrgRsc		(ActChgCrsSta +  37)
#define ActDwnPrgRsc		(ActChgCrsSta +  38)
#define ActEdiTchGui		(ActChgCrsSta +  39)
#define ActSeeSylLec		(ActChgCrsSta +  40)
#define ActSeeSylPra		(ActChgCrsSta +  41)
#define ActEdiSylLec		(ActChgCrsSta +  42)
#define ActEdiSylPra		(ActChgCrsSta +  43)
#define ActDelItmSylLec		(ActChgCrsSta +  44)
#define ActDelItmSylPra		(ActChgCrsSta +  45)
#define ActUp_IteSylLec		(ActChgCrsSta +  46)
#define ActUp_IteSylPra		(ActChgCrsSta +  47)
#define ActDwnIteSylLec		(ActChgCrsSta +  48)
#define ActDwnIteSylPra		(ActChgCrsSta +  49)
#define ActRgtIteSylLec		(ActChgCrsSta +  50)
#define ActRgtIteSylPra		(ActChgCrsSta +  51)
#define ActLftIteSylLec		(ActChgCrsSta +  52)
#define ActLftIteSylPra		(ActChgCrsSta +  53)
#define ActInsIteSylLec		(ActChgCrsSta +  54)
#define ActInsIteSylPra		(ActChgCrsSta +  55)
#define ActModIteSylLec		(ActChgCrsSta +  56)
#define ActModIteSylPra		(ActChgCrsSta +  57)

#define ActEdiBib		(ActChgCrsSta +  58)
#define ActEdiFAQ		(ActChgCrsSta +  59)
#define ActEdiCrsLnk		(ActChgCrsSta +  60)

#define ActChgFrcReaCrsInf	(ActChgCrsSta +  61)
#define ActChgFrcReaTchGui	(ActChgCrsSta +  62)
#define ActChgFrcReaSylLec	(ActChgCrsSta +  63)
#define ActChgFrcReaSylPra	(ActChgCrsSta +  64)
#define ActChgFrcReaBib		(ActChgCrsSta +  65)
#define ActChgFrcReaFAQ		(ActChgCrsSta +  66)
#define ActChgFrcReaCrsLnk	(ActChgCrsSta +  67)

#define ActChgHavReaCrsInf	(ActChgCrsSta +  68)
#define ActChgHavReaTchGui	(ActChgCrsSta +  69)
#define ActChgHavReaSylLec	(ActChgCrsSta +  70)
#define ActChgHavReaSylPra	(ActChgCrsSta +  71)
#define ActChgHavReaBib		(ActChgCrsSta +  72)
#define ActChgHavReaFAQ		(ActChgCrsSta +  73)
#define ActChgHavReaCrsLnk	(ActChgCrsSta +  74)

#define ActSelInfSrcCrsInf	(ActChgCrsSta +  75)
#define ActSelInfSrcTchGui	(ActChgCrsSta +  76)
#define ActSelInfSrcSylLec	(ActChgCrsSta +  77)
#define ActSelInfSrcSylPra	(ActChgCrsSta +  78)
#define ActSelInfSrcBib		(ActChgCrsSta +  79)
#define ActSelInfSrcFAQ		(ActChgCrsSta +  80)
#define ActSelInfSrcCrsLnk	(ActChgCrsSta +  81)
#define ActRcvURLCrsInf		(ActChgCrsSta +  82)
#define ActRcvURLTchGui		(ActChgCrsSta +  83)
#define ActRcvURLSylLec		(ActChgCrsSta +  84)
#define ActRcvURLSylPra		(ActChgCrsSta +  85)
#define ActRcvURLBib		(ActChgCrsSta +  86)
#define ActRcvURLFAQ		(ActChgCrsSta +  87)
#define ActRcvURLCrsLnk		(ActChgCrsSta +  88)
#define ActRcvPagCrsInf		(ActChgCrsSta +  89)
#define ActRcvPagTchGui		(ActChgCrsSta +  90)
#define ActRcvPagSylLec		(ActChgCrsSta +  91)
#define ActRcvPagSylPra		(ActChgCrsSta +  92)
#define ActRcvPagBib		(ActChgCrsSta +  93)
#define ActRcvPagFAQ		(ActChgCrsSta +  94)
#define ActRcvPagCrsLnk		(ActChgCrsSta +  95)
#define ActEditorCrsInf		(ActChgCrsSta +  96)
#define ActEditorTchGui		(ActChgCrsSta +  97)
#define ActEditorSylLec		(ActChgCrsSta +  98)
#define ActEditorSylPra		(ActChgCrsSta +  99)
#define ActEditorBib		(ActChgCrsSta + 100)
#define ActEditorFAQ		(ActChgCrsSta + 101)
#define ActEditorCrsLnk		(ActChgCrsSta + 102)
#define ActPlaTxtEdiCrsInf	(ActChgCrsSta + 103)
#define ActPlaTxtEdiTchGui	(ActChgCrsSta + 104)
#define ActPlaTxtEdiSylLec	(ActChgCrsSta + 105)
#define ActPlaTxtEdiSylPra	(ActChgCrsSta + 106)
#define ActPlaTxtEdiBib		(ActChgCrsSta + 107)
#define ActPlaTxtEdiFAQ		(ActChgCrsSta + 108)
#define ActPlaTxtEdiCrsLnk	(ActChgCrsSta + 109)
#define ActRchTxtEdiCrsInf	(ActChgCrsSta + 110)
#define ActRchTxtEdiTchGui	(ActChgCrsSta + 111)
#define ActRchTxtEdiSylLec	(ActChgCrsSta + 112)
#define ActRchTxtEdiSylPra	(ActChgCrsSta + 113)
#define ActRchTxtEdiBib		(ActChgCrsSta + 114)
#define ActRchTxtEdiFAQ		(ActChgCrsSta + 115)
#define ActRchTxtEdiCrsLnk	(ActChgCrsSta + 116)
#define ActRcvPlaTxtCrsInf	(ActChgCrsSta + 117)
#define ActRcvPlaTxtTchGui	(ActChgCrsSta + 118)
#define ActRcvPlaTxtSylLec	(ActChgCrsSta + 119)
#define ActRcvPlaTxtSylPra	(ActChgCrsSta + 120)
#define ActRcvPlaTxtBib		(ActChgCrsSta + 121)
#define ActRcvPlaTxtFAQ		(ActChgCrsSta + 122)
#define ActRcvPlaTxtCrsLnk	(ActChgCrsSta + 123)
#define ActRcvRchTxtCrsInf	(ActChgCrsSta + 124)
#define ActRcvRchTxtTchGui	(ActChgCrsSta + 125)
#define ActRcvRchTxtSylLec	(ActChgCrsSta + 126)
#define ActRcvRchTxtSylPra	(ActChgCrsSta + 127)
#define ActRcvRchTxtBib		(ActChgCrsSta + 128)
#define ActRcvRchTxtFAQ		(ActChgCrsSta + 129)
#define ActRcvRchTxtCrsLnk	(ActChgCrsSta + 130)

#define ActPrnCrsTT		(ActChgCrsSta + 131)
#define ActEdiCrsTT		(ActChgCrsSta + 132)
#define ActChgCrsTT		(ActChgCrsSta + 133)
#define ActChgCrsTT1stDay	(ActChgCrsSta + 134)
