...
#define ActSeeNewNtf		(ActWebSvc +  45)
#define ActMrkNtfSee		(ActWebSvc +  46)
...
// Secondary actions
#define ActEdiCty		(ActRenMaiFul +  7)
#define ActNewCty		(ActRenMaiFul +  8)
#define ActRemCty		(ActRenMaiFul +  9)
#define ActRenCty		(ActRenMaiFul + 10)
#define ActChgCtyWWW		(ActRenMaiFul + 11)

#define ActReqRemOldCrs		(ActRenMaiFul + 12)
#define ActRemOldCrs		(ActRenMaiFul + 13)

#define ActSeeBan		(ActRenMaiFul + 14)
#define ActEdiBan		(ActRenMaiFul + 15)
#define ActNewBan		(ActRenMaiFul + 16)
#define ActRemBan		(ActRenMaiFul + 17)
#define ActShoBan		(ActRenMaiFul + 18)
#define ActHidBan		(ActRenMaiFul + 19)
#define ActRenBanSho		(ActRenMaiFul + 20)
#define ActRenBanFul		(ActRenMaiFul + 21)
#define ActChgBanImg		(ActRenMaiFul + 22)
#define ActChgBanWWW		(ActRenMaiFul + 23)
#define ActClkBan		(ActRenMaiFul + 24)

#define ActEdiLnk		(ActRenMaiFul + 25)
#define ActNewLnk		(ActRenMaiFul + 26)
#define ActRemLnk		(ActRenMaiFul + 27)
#define ActRenLnkSho		(ActRenMaiFul + 28)
#define ActRenLnkFul		(ActRenMaiFul + 29)
#define ActChgLnkWWW		(ActRenMaiFul + 30)

#define ActEdiPlg		(ActRenMaiFul + 31)
#define ActNewPlg		(ActRenMaiFul + 32)
#define ActRemPlg		(ActRenMaiFul + 33)
#define ActRenPlg		(ActRenMaiFul + 34)
#define ActChgPlgDes		(ActRenMaiFul + 35)
#define ActChgPlgLog		(ActRenMaiFul + 36)
#define ActChgPlgAppKey		(ActRenMaiFul + 37)
#define ActChgPlgURL		(ActRenMaiFul + 38)
#define ActChgPlgIP		(ActRenMaiFul + 39)
