...
#define Act_NUM_ACTIONS	(1 + 9 + 176 + 43 + 17 + 47 + 41 + 24 + 115 + 157 + 437 + 165 + 42 + 15 + 72)
...
#define ActRcvSocPstGbl		(ActWebSvc +   9)
#define ActRcvSocComGbl		(ActWebSvc +  10)
#define ActShaSocNotGbl		(ActWebSvc +  11)
#define ActUnsSocNotGbl		(ActWebSvc +  12)
#define ActFavSocNotGbl		(ActWebSvc +  13)
#define ActUnfSocNotGbl		(ActWebSvc +  14)
#define ActFavSocComGbl		(ActWebSvc +  15)
#define ActUnfSocComGbl		(ActWebSvc +  16)
#define ActReqRemSocPubGbl	(ActWebSvc +  17)
#define ActRemSocPubGbl		(ActWebSvc +  18)
#define ActReqRemSocComGbl	(ActWebSvc +  19)
#define ActRemSocComGbl		(ActWebSvc +  20)

#define ActReqOthPubPrf		(ActWebSvc +  21)

#define ActRcvSocPstUsr		(ActWebSvc +  22)
#define ActRcvSocComUsr		(ActWebSvc +  23)
#define ActShaSocNotUsr		(ActWebSvc +  24)
#define ActUnsSocNotUsr		(ActWebSvc +  25)
#define ActFavSocNotUsr		(ActWebSvc +  26)
#define ActUnfSocNotUsr		(ActWebSvc +  27)
#define ActFavSocComUsr		(ActWebSvc +  28)
#define ActUnfSocComUsr		(ActWebSvc +  29)
#define ActReqRemSocPubUsr	(ActWebSvc +  30)
#define ActRemSocPubUsr		(ActWebSvc +  31)
#define ActReqRemSocComUsr	(ActWebSvc +  32)
#define ActRemSocComUsr		(ActWebSvc +  33)

#define ActSeeOthPubPrf		(ActWebSvc +  34)
#define ActCal1stClkTim		(ActWebSvc +  35)
#define ActCalNumClk		(ActWebSvc +  36)
#define ActCalNumFilVie		(ActWebSvc +  37)
#define ActCalNumForPst		(ActWebSvc +  38)
#define ActCalNumMsgSnt		(ActWebSvc +  39)

#define ActFolUsr		(ActWebSvc +  40)
#define ActUnfUsr		(ActWebSvc +  41)
#define ActSeeFlg		(ActWebSvc +  42)
#define ActSeeFlr		(ActWebSvc +  43)

#define ActSeeForCrsUsr		(ActWebSvc +  44)
#define ActSeeForCrsTch		(ActWebSvc +  45)
#define ActSeeForDegUsr		(ActWebSvc +  46)
#define ActSeeForDegTch		(ActWebSvc +  47)
#define ActSeeForCtrUsr		(ActWebSvc +  48)
#define ActSeeForCtrTch		(ActWebSvc +  49)
#define ActSeeForInsUsr		(ActWebSvc +  50)
#define ActSeeForInsTch		(ActWebSvc +  51)
#define ActSeeForGenUsr		(ActWebSvc +  52)
#define ActSeeForGenTch		(ActWebSvc +  53)
#define ActSeeForSWAUsr		(ActWebSvc +  54)
#define ActSeeForSWATch		(ActWebSvc +  55)
#define ActSeePstForCrsUsr	(ActWebSvc +  56)
#define ActSeePstForCrsTch	(ActWebSvc +  57)
#define ActSeePstForDegUsr	(ActWebSvc +  58)
#define ActSeePstForDegTch	(ActWebSvc +  59)
#define ActSeePstForCtrUsr	(ActWebSvc +  60)
#define ActSeePstForCtrTch	(ActWebSvc +  61)
#define ActSeePstForInsUsr	(ActWebSvc +  62)
#define ActSeePstForInsTch	(ActWebSvc +  63)
#define ActSeePstForGenUsr	(ActWebSvc +  64)
#define ActSeePstForGenTch	(ActWebSvc +  65)
#define ActSeePstForSWAUsr	(ActWebSvc +  66)
#define ActSeePstForSWATch	(ActWebSvc +  67)
#define ActRcvThrForCrsUsr	(ActWebSvc +  68)
#define ActRcvThrForCrsTch	(ActWebSvc +  69)
#define ActRcvThrForDegUsr	(ActWebSvc +  70)
#define ActRcvThrForDegTch	(ActWebSvc +  71)
#define ActRcvThrForCtrUsr	(ActWebSvc +  72)
#define ActRcvThrForCtrTch	(ActWebSvc +  73)
#define ActRcvThrForInsUsr	(ActWebSvc +  74)
#define ActRcvThrForInsTch	(ActWebSvc +  75)
#define ActRcvThrForGenUsr	(ActWebSvc +  76)
#define ActRcvThrForGenTch	(ActWebSvc +  77)
#define ActRcvThrForSWAUsr	(ActWebSvc +  78)
#define ActRcvThrForSWATch	(ActWebSvc +  79)
#define ActRcvRepForCrsUsr	(ActWebSvc +  80)
#define ActRcvRepForCrsTch	(ActWebSvc +  81)
#define ActRcvRepForDegUsr	(ActWebSvc +  82)
#define ActRcvRepForDegTch	(ActWebSvc +  83)
#define ActRcvRepForCtrUsr	(ActWebSvc +  84)
#define ActRcvRepForCtrTch	(ActWebSvc +  85)
#define ActRcvRepForInsUsr	(ActWebSvc +  86)
#define ActRcvRepForInsTch	(ActWebSvc +  87)
#define ActRcvRepForGenUsr	(ActWebSvc +  88)
#define ActRcvRepForGenTch	(ActWebSvc +  89)
#define ActRcvRepForSWAUsr	(ActWebSvc +  90)
#define ActRcvRepForSWATch	(ActWebSvc +  91)
#define ActReqDelThrCrsUsr	(ActWebSvc +  92)
#define ActReqDelThrCrsTch	(ActWebSvc +  93)
#define ActReqDelThrDegUsr	(ActWebSvc +  94)
#define ActReqDelThrDegTch	(ActWebSvc +  95)
#define ActReqDelThrCtrUsr	(ActWebSvc +  96)
#define ActReqDelThrCtrTch	(ActWebSvc +  97)
#define ActReqDelThrInsUsr	(ActWebSvc +  98)
#define ActReqDelThrInsTch	(ActWebSvc +  99)
#define ActReqDelThrGenUsr	(ActWebSvc + 100)
#define ActReqDelThrGenTch	(ActWebSvc + 101)
#define ActReqDelThrSWAUsr	(ActWebSvc + 102)
#define ActReqDelThrSWATch	(ActWebSvc + 103)
#define ActDelThrForCrsUsr	(ActWebSvc + 104)
#define ActDelThrForCrsTch	(ActWebSvc + 105)
#define ActDelThrForDegUsr	(ActWebSvc + 106)
#define ActDelThrForDegTch	(ActWebSvc + 107)
#define ActDelThrForCtrUsr	(ActWebSvc + 108)
#define ActDelThrForCtrTch	(ActWebSvc + 109)
#define ActDelThrForInsUsr	(ActWebSvc + 110)
#define ActDelThrForInsTch	(ActWebSvc + 111)
#define ActDelThrForGenUsr	(ActWebSvc + 112)
#define ActDelThrForGenTch	(ActWebSvc + 113)
#define ActDelThrForSWAUsr	(ActWebSvc + 114)
#define ActDelThrForSWATch	(ActWebSvc + 115)
#define ActCutThrForCrsUsr	(ActWebSvc + 116)
#define ActCutThrForCrsTch	(ActWebSvc + 117)
#define ActCutThrForDegUsr	(ActWebSvc + 118)
#define ActCutThrForDegTch	(ActWebSvc + 119)
#define ActCutThrForCtrUsr	(ActWebSvc + 120)
#define ActCutThrForCtrTch	(ActWebSvc + 121)
#define ActCutThrForInsUsr	(ActWebSvc + 122)
#define ActCutThrForInsTch	(ActWebSvc + 123)
#define ActCutThrForGenUsr	(ActWebSvc + 124)
#define ActCutThrForGenTch	(ActWebSvc + 125)
#define ActCutThrForSWAUsr	(ActWebSvc + 126)
#define ActCutThrForSWATch	(ActWebSvc + 127)
#define ActPasThrForCrsUsr	(ActWebSvc + 128)
#define ActPasThrForCrsTch	(ActWebSvc + 129)
#define ActPasThrForDegUsr	(ActWebSvc + 130)
#define ActPasThrForDegTch	(ActWebSvc + 131)
#define ActPasThrForCtrUsr	(ActWebSvc + 132)
#define ActPasThrForCtrTch	(ActWebSvc + 133)
#define ActPasThrForInsUsr	(ActWebSvc + 134)
#define ActPasThrForInsTch	(ActWebSvc + 135)
#define ActPasThrForGenUsr	(ActWebSvc + 136)
#define ActPasThrForGenTch	(ActWebSvc + 137)
#define ActPasThrForSWAUsr	(ActWebSvc + 138)
#define ActPasThrForSWATch	(ActWebSvc + 139)
#define ActDelPstForCrsUsr	(ActWebSvc + 140)
#define ActDelPstForCrsTch	(ActWebSvc + 141)
#define ActDelPstForDegUsr	(ActWebSvc + 142)
#define ActDelPstForDegTch	(ActWebSvc + 143)
#define ActDelPstForCtrUsr	(ActWebSvc + 144)
#define ActDelPstForCtrTch	(ActWebSvc + 145)
#define ActDelPstForInsUsr	(ActWebSvc + 146)
#define ActDelPstForInsTch	(ActWebSvc + 147)
#define ActDelPstForGenUsr	(ActWebSvc + 148)
#define ActDelPstForGenTch	(ActWebSvc + 149)
#define ActDelPstForSWAUsr	(ActWebSvc + 150)
#define ActDelPstForSWATch	(ActWebSvc + 151)
#define ActEnbPstForCrsUsr	(ActWebSvc + 152)
#define ActEnbPstForCrsTch	(ActWebSvc + 153)
#define ActEnbPstForDegUsr	(ActWebSvc + 154)
#define ActEnbPstForDegTch	(ActWebSvc + 155)
#define ActEnbPstForCtrUsr	(ActWebSvc + 156)
#define ActEnbPstForCtrTch	(ActWebSvc + 157)
#define ActEnbPstForInsUsr	(ActWebSvc + 158)
#define ActEnbPstForInsTch	(ActWebSvc + 159)
#define ActEnbPstForGenUsr	(ActWebSvc + 160)
#define ActEnbPstForGenTch	(ActWebSvc + 161)
#define ActEnbPstForSWAUsr	(ActWebSvc + 162)
#define ActEnbPstForSWATch	(ActWebSvc + 163)
#define ActDisPstForCrsUsr	(ActWebSvc + 164)
#define ActDisPstForCrsTch	(ActWebSvc + 165)
#define ActDisPstForDegUsr	(ActWebSvc + 166)
#define ActDisPstForDegTch	(ActWebSvc + 167)
#define ActDisPstForCtrUsr	(ActWebSvc + 168)
#define ActDisPstForCtrTch	(ActWebSvc + 169)
#define ActDisPstForInsUsr	(ActWebSvc + 170)
#define ActDisPstForInsTch	(ActWebSvc + 171)
#define ActDisPstForGenUsr	(ActWebSvc + 172)
#define ActDisPstForGenTch	(ActWebSvc + 173)
#define ActDisPstForSWAUsr	(ActWebSvc + 174)
#define ActDisPstForSWATch	(ActWebSvc + 175)

#define ActCht			(ActWebSvc + 176)
