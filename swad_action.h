...
#define ActReqRemSocComGbl	(ActLstClk+ 11)
#define ActRemSocComGbl		(ActLstClk+ 12)

#define ActRcvSocPstUsr		(ActLstClk+ 13)
#define ActRcvSocComUsr		(ActLstClk+ 14)
...
#define ActReqRemSocComUsr	(ActLstClk+ 19)
#define ActRemSocComUsr		(ActLstClk+ 20)

#define ActSeePubPrf		(ActLstClk+ 21)
#define ActCal1stClkTim		(ActLstClk+ 22)
#define ActCalNumClk		(ActLstClk+ 23)
#define ActCalNumFilVie		(ActLstClk+ 24)
#define ActCalNumForPst		(ActLstClk+ 25)
#define ActCalNumMsgSnt		(ActLstClk+ 26)

#define ActFolUsr		(ActLstClk+ 27)
#define ActUnfUsr		(ActLstClk+ 28)
#define ActSeeFlg		(ActLstClk+ 29)
#define ActSeeFlr		(ActLstClk+ 30)

#define ActSeeForCrsUsr		(ActLstClk+ 31)
#define ActSeeForCrsTch		(ActLstClk+ 32)
#define ActSeeForDegUsr		(ActLstClk+ 33)
#define ActSeeForDegTch		(ActLstClk+ 34)
#define ActSeeForCtrUsr		(ActLstClk+ 35)
#define ActSeeForCtrTch		(ActLstClk+ 36)
#define ActSeeForInsUsr		(ActLstClk+ 37)
#define ActSeeForInsTch		(ActLstClk+ 38)
#define ActSeeForGenUsr		(ActLstClk+ 39)
#define ActSeeForGenTch		(ActLstClk+ 40)
#define ActSeeForSWAUsr		(ActLstClk+ 41)
#define ActSeeForSWATch		(ActLstClk+ 42)
#define ActSeePstForCrsUsr	(ActLstClk+ 43)
#define ActSeePstForCrsTch	(ActLstClk+ 44)
#define ActSeePstForDegUsr	(ActLstClk+ 45)
#define ActSeePstForDegTch	(ActLstClk+ 46)
#define ActSeePstForCtrUsr	(ActLstClk+ 47)
#define ActSeePstForCtrTch	(ActLstClk+ 48)
#define ActSeePstForInsUsr	(ActLstClk+ 49)
#define ActSeePstForInsTch	(ActLstClk+ 50)
#define ActSeePstForGenUsr	(ActLstClk+ 51)
#define ActSeePstForGenTch	(ActLstClk+ 52)
#define ActSeePstForSWAUsr	(ActLstClk+ 53)
#define ActSeePstForSWATch	(ActLstClk+ 54)
#define ActRcvThrForCrsUsr	(ActLstClk+ 55)
#define ActRcvThrForCrsTch	(ActLstClk+ 56)
#define ActRcvThrForDegUsr	(ActLstClk+ 57)
#define ActRcvThrForDegTch	(ActLstClk+ 58)
#define ActRcvThrForCtrUsr	(ActLstClk+ 59)
#define ActRcvThrForCtrTch	(ActLstClk+ 60)
#define ActRcvThrForInsUsr	(ActLstClk+ 61)
#define ActRcvThrForInsTch	(ActLstClk+ 62)
#define ActRcvThrForGenUsr	(ActLstClk+ 63)
#define ActRcvThrForGenTch	(ActLstClk+ 64)
#define ActRcvThrForSWAUsr	(ActLstClk+ 65)
#define ActRcvThrForSWATch	(ActLstClk+ 66)
#define ActRcvRepForCrsUsr	(ActLstClk+ 67)
#define ActRcvRepForCrsTch	(ActLstClk+ 68)
#define ActRcvRepForDegUsr	(ActLstClk+ 69)
#define ActRcvRepForDegTch	(ActLstClk+ 70)
#define ActRcvRepForCtrUsr	(ActLstClk+ 71)
#define ActRcvRepForCtrTch	(ActLstClk+ 72)
#define ActRcvRepForInsUsr	(ActLstClk+ 73)
#define ActRcvRepForInsTch	(ActLstClk+ 74)
#define ActRcvRepForGenUsr	(ActLstClk+ 75)
#define ActRcvRepForGenTch	(ActLstClk+ 76)
#define ActRcvRepForSWAUsr	(ActLstClk+ 77)
#define ActRcvRepForSWATch	(ActLstClk+ 78)
#define ActReqDelThrCrsUsr	(ActLstClk+ 79)
#define ActReqDelThrCrsTch	(ActLstClk+ 80)
#define ActReqDelThrDegUsr	(ActLstClk+ 81)
#define ActReqDelThrDegTch	(ActLstClk+ 82)
#define ActReqDelThrCtrUsr	(ActLstClk+ 83)
#define ActReqDelThrCtrTch	(ActLstClk+ 84)
#define ActReqDelThrInsUsr	(ActLstClk+ 85)
#define ActReqDelThrInsTch	(ActLstClk+ 86)
#define ActReqDelThrGenUsr	(ActLstClk+ 87)
#define ActReqDelThrGenTch	(ActLstClk+ 88)
#define ActReqDelThrSWAUsr	(ActLstClk+ 89)
#define ActReqDelThrSWATch	(ActLstClk+ 90)
#define ActDelThrForCrsUsr	(ActLstClk+ 91)
#define ActDelThrForCrsTch	(ActLstClk+ 92)
#define ActDelThrForDegUsr	(ActLstClk+ 93)
#define ActDelThrForDegTch	(ActLstClk+ 94)
#define ActDelThrForCtrUsr	(ActLstClk+ 95)
#define ActDelThrForCtrTch	(ActLstClk+ 96)
#define ActDelThrForInsUsr	(ActLstClk+ 97)
#define ActDelThrForInsTch	(ActLstClk+ 98)
#define ActDelThrForGenUsr	(ActLstClk+ 99)
#define ActDelThrForGenTch	(ActLstClk+100)
#define ActDelThrForSWAUsr	(ActLstClk+101)
#define ActDelThrForSWATch	(ActLstClk+102)
#define ActCutThrForCrsUsr	(ActLstClk+103)
#define ActCutThrForCrsTch	(ActLstClk+104)
#define ActCutThrForDegUsr	(ActLstClk+105)
#define ActCutThrForDegTch	(ActLstClk+106)
#define ActCutThrForCtrUsr	(ActLstClk+107)
#define ActCutThrForCtrTch	(ActLstClk+108)
#define ActCutThrForInsUsr	(ActLstClk+109)
#define ActCutThrForInsTch	(ActLstClk+110)
#define ActCutThrForGenUsr	(ActLstClk+111)
#define ActCutThrForGenTch	(ActLstClk+112)
#define ActCutThrForSWAUsr	(ActLstClk+113)
#define ActCutThrForSWATch	(ActLstClk+114)
#define ActPasThrForCrsUsr	(ActLstClk+115)
#define ActPasThrForCrsTch	(ActLstClk+116)
#define ActPasThrForDegUsr	(ActLstClk+117)
#define ActPasThrForDegTch	(ActLstClk+118)
#define ActPasThrForCtrUsr	(ActLstClk+119)
#define ActPasThrForCtrTch	(ActLstClk+120)
#define ActPasThrForInsUsr	(ActLstClk+121)
#define ActPasThrForInsTch	(ActLstClk+122)
#define ActPasThrForGenUsr	(ActLstClk+123)
#define ActPasThrForGenTch	(ActLstClk+124)
#define ActPasThrForSWAUsr	(ActLstClk+125)
#define ActPasThrForSWATch	(ActLstClk+126)
#define ActDelPstForCrsUsr	(ActLstClk+127)
#define ActDelPstForCrsTch	(ActLstClk+128)
#define ActDelPstForDegUsr	(ActLstClk+129)
#define ActDelPstForDegTch	(ActLstClk+130)
#define ActDelPstForCtrUsr	(ActLstClk+131)
#define ActDelPstForCtrTch	(ActLstClk+132)
#define ActDelPstForInsUsr	(ActLstClk+133)
#define ActDelPstForInsTch	(ActLstClk+134)
#define ActDelPstForGenUsr	(ActLstClk+135)
#define ActDelPstForGenTch	(ActLstClk+136)
#define ActDelPstForSWAUsr	(ActLstClk+137)
#define ActDelPstForSWATch	(ActLstClk+138)
#define ActEnbPstForCrsUsr	(ActLstClk+139)
#define ActEnbPstForCrsTch	(ActLstClk+140)
#define ActEnbPstForDegUsr	(ActLstClk+141)
#define ActEnbPstForDegTch	(ActLstClk+142)
#define ActEnbPstForCtrUsr	(ActLstClk+143)
#define ActEnbPstForCtrTch	(ActLstClk+144)
#define ActEnbPstForInsUsr	(ActLstClk+145)
#define ActEnbPstForInsTch	(ActLstClk+146)
#define ActEnbPstForGenUsr	(ActLstClk+147)
#define ActEnbPstForGenTch	(ActLstClk+148)
#define ActEnbPstForSWAUsr	(ActLstClk+149)
#define ActEnbPstForSWATch	(ActLstClk+150)
#define ActDisPstForCrsUsr	(ActLstClk+151)
#define ActDisPstForCrsTch	(ActLstClk+152)
#define ActDisPstForDegUsr	(ActLstClk+153)
#define ActDisPstForDegTch	(ActLstClk+154)
#define ActDisPstForCtrUsr	(ActLstClk+155)
#define ActDisPstForCtrTch	(ActLstClk+156)
#define ActDisPstForInsUsr	(ActLstClk+157)
#define ActDisPstForInsTch	(ActLstClk+158)
#define ActDisPstForGenUsr	(ActLstClk+159)
#define ActDisPstForGenTch	(ActLstClk+160)
#define ActDisPstForSWAUsr	(ActLstClk+161)
#define ActDisPstForSWATch	(ActLstClk+162)

#define ActCht			(ActLstClk+163)
