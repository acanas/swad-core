...
#define ActReqEdiMyIns		(ActSeeAllStaCrs+ 6)
#define ActReqEdiMyNet		(ActSeeAllStaCrs+ 7)
#define ActEdiPrf		(ActSeeAllStaCrs+ 8)
#define ActAdmBrf		(ActSeeAllStaCrs+ 9)
#define ActMFUAct		(ActSeeAllStaCrs+10)
// Secondary actions
#define ActAutUsrInt		(ActSeeAllStaCrs+11)
#define ActAutUsrExt		(ActSeeAllStaCrs+12)
#define ActAutUsrChgLan		(ActSeeAllStaCrs+13)
#define ActLogOut		(ActSeeAllStaCrs+14)
#define ActAnnSee		(ActSeeAllStaCrs+15)
...
#define ActReqSndNewPwd		(ActSeeAllStaCrs+25)
#define ActSndNewPwd		(ActSeeAllStaCrs+26)
