...
#define ActNewSvyQst		(ActMaiUsr + 26)
#define ActChgSvyQst		(ActMaiUsr + 27)
#define ActReqRemSvyQst		(ActMaiUsr + 28)
#define ActRemSvyQst		(ActMaiUsr + 29)

#define ActSeeAccGbl		(ActMaiUsr + 30)
#define ActReqAccCrs		(ActMaiUsr + 31)
#define ActSeeAccCrs		(ActMaiUsr + 32)

#define ActLstClk		(ActMaiUsr + 33)
#define ActRefLstClk		(ActMaiUsr + 34)

#define ActSeeMyUsgRep		(ActMaiUsr + 35)
