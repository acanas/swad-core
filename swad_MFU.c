...
#define MFU_MAX_BYTES_TAB	((MFU_MAX_CHARS_TAB + 1) * Cns_MAX_BYTES_PER_CHAR - 1)	// 2047

#define MFU_MAX_CHARS_MENU	(128 - 1)	// 127
#define MFU_MAX_BYTES_MENU	((MFU_MAX_CHARS_MENU + 1) * Cns_MAX_BYTES_PER_CHAR - 1)	// 2047
