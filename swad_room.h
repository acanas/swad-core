...
typedef enum
  {
   ...
   Roo_CLASSROOM      =  5,	// "chalkboard-user.svg" "chalkboard.svg"		// "Aula"
   Roo_CONCIERGE      =  6,	// "concierge-bell" "user-gear.svg" "house-user.svg" 	// "Conserjería/Portería"
   ...
   Roo_SEMINAR        = 19,	// "chalkboard-user.svg" "chalkboard.svg"		// "Seminario"
