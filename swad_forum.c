...
static void For_ShowAForumPost (unsigned PstNum,long PstCod,
                                ...
                                bool NewPst,bool ICanModerateForum)
  {
   ...
   /***** Write subject *****/
   Tbl_TD_Begin ("class=\"%s LT\"",NewPst ? "MSG_TIT_BG_NEW" :
        					  "MSG_TIT_BG");
   if (Enabled)
     {
      if (Subject[0])
   ...
   Tbl_TD_Begin ("colspan=\"2\" class=\"AUTHOR_TXT LT\" style=\"width:150px;\"");
   ...
   if (NumThrs)
	   ...
	   Order++)
	{
	 ...
	 fprintf (Gbl.F.Out,"%s",Txt_FORUM_THREAD_ORDER[Order]);
      ...
      Tbl_TH (1,1,"RM",Txt_No_BR_msgs);
      Tbl_TH (1,1,"RM",Txt_Unread_BR_msgs);
      Tbl_TH (1,1,"RM",Txt_WriBRters);
      Tbl_TH (1,1,"RM",Txt_ReaBRders);
	 ...
	 For_PutAllHiddenParamsForum (Gbl.Forum.CurrentPageThrs,	// Page of threads = current
      ...
      for (Order = For_FIRST_MSG;
	   ...
	   Order++)
	    ...
	    UniqueId++;
            Tbl_TD_Begin ("id=\"thr_date_%u\" class=\"%s LT %s\"",
